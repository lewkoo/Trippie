...
module.exports = function(app) {
    ...
    app.get('/trips/:tripId/:destinationId', destinations.show);
    app.put('/trips/:tripId/:destinationId', authorization.requiresLogin, hasAuthorization, destinations.update);
    app.del('/trips/:tripId/:destinationId', authorization.requiresLogin, hasAuthorization, destinations.destroy);
