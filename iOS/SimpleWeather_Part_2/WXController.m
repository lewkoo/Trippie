...
- (void)viewDidLoad {
    ...
    CGFloat tripsbuttonX = headerFrame.size.width - 350;
    CGFloat tripsbuttonY = headerFrame.size.height - 300;
    CGFloat tripsbuttonHeight = 300;
